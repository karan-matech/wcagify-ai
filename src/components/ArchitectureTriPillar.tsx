...
import { Cpu, ShieldCheck, UserCheck, Sparkles, Check, ArrowRight } from 'lucide-react';
...
export const ArchitectureTriPillar: React.FC = () => {
  ...
  const pillars = [
    {
      ...
      color: 'indigo',
      shortDesc: 'Generates natural language alt-text, understands complex visual layouts, and infers document reading hierarchies.',
      capabilities: [
      ...
      techSpecs: 'Powered by Gemini Multi-Modal Vision & Semantic Reasoning Models running server-side in secure Cloud Run containers.'
    },
    {
      id: 2,
      ...
      color: 'emerald',
      shortDesc: 'Enforces strict structural rules for ISO 14289-1 PDF/UA tag trees, ARIA landmarks, and contrast ratios.',
      capabilities: [
      ...
      techSpecs: 'Zero hallucination guaranteed through deterministic AST parsers, veraPDF engines, and axe-core compliance rulesets.'
    },
    {
      id: 3,
      title: 'Human Expert Workspace',
      sub: 'Judgment & QA',
      icon: <UserCheck className="w-6 h-6 text-indigo-600" aria-hidden="true" />,
      color: 'amber',
      shortDesc: 'Empowers accessibility experts with an integrated workspace to review high-complexity edge cases.',
      capabilities: [
      ...
      techSpecs: 'Collaborative audit interface with real-time screen reader simulation and automated compliance sign-off logs.'
    }
  ];
  ...
  return (
    <section id="architecture" className="py-16 lg:py-24 bg-slate-900 text-white border-b border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-base sm:text-lg text-slate-300">
            Blending AI Reasoning, Deterministic Software Precision, and Human Judgment to guarantee 100% compliance at scale.
          </p>
        </div>
        ...
        <div className="bg-slate-950 p-6 sm:p-8 rounded-2xl border border-slate-800 space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-800 pb-4">
            <div>
              <span className="text-xs font-bold uppercase text-indigo-400">Pillar 0{activePillarData.id} In-Depth</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="p-5 bg-slate-900 rounded-xl border border-slate-800 space-y-3 flex flex-col justify-between">
              <div>
                <span className="text-xs font-bold uppercase text-slate-400 block mb-2">Technical Implementation Specification</span>
              ...
              <div className="pt-4 border-t border-slate-800 flex items-center justify-between text-xs text-slate-400">
                ...
                <span className="text-emerald-400 font-bold">100% Zero-Regression Guarantee</span>
              </div>
            </div>
          </div>
        </div>
