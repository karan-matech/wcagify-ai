...
export const FeatureTabs: React.FC = () => {
  ...
  const categories: AssetCategory[] = [
    {
      ...
      simpleDescription:
        "Reconstructs web pages so everyone can register, pay, and navigate—using a mouse, keyboard, or screen reader.",
      beforeProblem:
        "Inaccessible buttons made from <div> tags, missing label connections, and unreadable faint grey text.",
      afterSolution:
        "Native semantic elements with clear focus outlines, high-contrast text, and screen reader announcements.",
      speechScript:
        "Checkout Page. Cardholder Name field required. Complete Purchase button, focused.",
      visualPreview: {
        beforeTitle: "Broken Web Form",
        beforeDetails: [
          "Mouse-only click handler",
          "Contrast ratio 1.8:1 (Unreadable)",
          "No screen reader labels",
        ],
        afterTitle: "Natively Fixed Web Form",
        afterDetails: [
          "Full keyboard focus ring",
          "WCAG 7.2:1 contrast ratio",
  ...
  <span class="text-slate-900 font-bold">Complete Purchase</span>
    ...
    },
    {
      ...
      simpleDescription:
        "Scans contracts, financial reports, and forms to build structured reading orders and alt text automatically.",
      beforeProblem:
        "Screen readers read PDF text out of order or report the document as a completely blank image.",
      afterSolution:
        "Programmatic ISO 14289 tag tree added directly to the PDF structure, ensuring veraPDF compliance.",
      speechScript:
        "Document Title: Q3 Financial Statement. Heading Level 1: Revenue Overview. Table with 4 columns and 12 rows.",
      visualPreview: {
        beforeTitle: "Raw Untagged PDF",
        beforeDetails: [
          "Scanned image with no text",
          "Columns read out of logical order",
          "Tables missing headers",
        ],
        afterTitle: "ISO 14289 PDF/UA Compliant",
        afterDetails: [
          "Logical reading order tree",
          "Tagged headers <h1> to <h3>",
          "Alt-text on charts & diagrams",
        ],
      },
...
<!-- ISO 14289 Programmatic Tag Tree -->`,
    },
    {
      ...
      simpleDescription:
        "Converts textbooks and manuscripts into accessible EPUB e-books with spoken MathML math formulas.",
      beforeProblem:
        "Scientific formulas and math equations are flattened images that screen readers cannot pronounce.",
      afterSolution:
        "Equations converted to native MathML for natural speech synthesis and reflowable text on e-readers.",
      speechScript:
        "Schrodinger equation: i times h-bar times partial derivative of psi over partial t.",
      visualPreview: {
        beforeTitle: "Flattened E-Book Image",
        beforeDetails: [
          "Math formulas as unreadable PNGs",
          "Fixed non-reflowable font sizes",
          "Missing table of contents",
        ],
        afterTitle: "Accessible EPUB 3 E-Book",
        afterDetails: [
          "Native MathML spoken equations",
          "Reflowable typography for large text",
  ...
  <mrow><mi>i</mi><mi>&#x210F;</mi><mfrac><mo>&#x2202;</mo><mrow><mo>&#x2202;</mo><mi>t</mi></mrow></mfrac><mi>&#x03C8;</mi></mrow>
    ...
    },
    {
      ...
      simpleDescription:
        "Remediates internal help desks, training portals, and wikis so all employees can work without barriers.",
      beforeProblem:
        "Keyboard users cannot open search dropdowns or copy code snippets in company portals.",
      afterSolution:
        "Accessible keyboard navigation, searchable tags, and high-contrast dark/light mode compatibility.",
      speechScript:
        "Search results: 3 articles found. Article 1: Security Access Control Policy. Press enter to open.",
      visualPreview: {
        beforeTitle: "Inaccessible Company Wiki",
        beforeDetails: [
          "Search dropdown unreachable via Tab key",
          "Copy code button gives no feedback",
          "Fails Section 508 standards",
        ],
        afterTitle: "Accessible Knowledge Base",
        afterDetails: [
          "Accessible search announcements",
          "Voice-over friendly navigation",
          "Fully Section 508 compliant",
        ],
      },
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-900 p-4 rounded-xl border border-slate-800 space-y-2.5">
                  <span className="text-xs font-bold uppercase tracking-wider text-slate-400 block">
                    {isTransformed
                      ? "Accessibility Capabilities Added:"
                  ...
                  <ul className="space-y-2">
                    {(isTransformed
                      ...
                      >
                        ...
                        <span
                          className={
                            isTransformed ? "text-slate-200" : "text-rose-300"
                          }
                        >
                          {item}
                        </span>
              ...
              <div className="p-4 bg-slate-950 rounded-2xl border border-slate-800 flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs text-slate-400">
                    WCAG 2.2 AA, ADA Title II & EAA EN 301 549
                  </span>
                </div>
              </div>
            </div>
